class Game
  ...
  # В конструкторе инициализируем две переменные экземпляра: массив букв загаданного слова и пустой массив
  # для дальнейшего сбора в него вводимых букв.
  def initialize(word)
    @letters = word.chars
    @user_guesses = []
  end

  # Возвращает массив букв, введенных пользователем, но отсутствующих в загаданном слове (ошибочные буквы)
  def errors
